...
```bash
python segment/predict.py --weights yolov5m-seg.pt --source data/images/dataset
```
...
```bash
python classify/predict.py --weights yolov5s-cls.pt --source data/images/dataset
```
