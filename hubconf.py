...
if __name__ == "__main__":
    ...
    # Images
    imgs = [
        "data/images/dataset/train/images",  # filename
        Path("data/image/dataset/train/images"),  # Path
        cv2.imread("data/image/dataset/train/images")[:, :, ::-1],  # OpenCV
        Image.open("data/image/dataset/train/images"),  # PIL
        np.zeros((320, 640, 3)),
    ]  # numpy
