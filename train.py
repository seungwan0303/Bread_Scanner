...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/images/dataset/data.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--workers", type=int, default=8, help="max dataloader workers (per RANK in DDP mode)") #cpu 쓰레드 코어 맞게
